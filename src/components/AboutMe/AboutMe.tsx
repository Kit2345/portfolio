    ...
    <>
      ...
      <div className="flex-row-center">
        ...
        <div className="margin-left-50">
          <h3>Background:</h3>
          <p>
            I'm a former academic scientist in cancer research and now looking
            to transition to become a software developer. As a scientist I have
            ...
            documentation and communication and above all a love of technology
      ...
      <div className="flex-row-center">
        ...
        <div className="margin-left-50">
          ...
          <p>
            I gained a love of travel when I visited South Africa with friends.
            It was amazing seeing the different cultures, exploring new places,
